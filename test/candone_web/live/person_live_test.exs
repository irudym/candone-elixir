defmodule CandoneWeb.PersonLiveTest do
  ...
  defp create_companies(_) do
    companies = [company_fixture(), company_fixture()]
    %{companies: companies}
  end
  ...
  describe "Show" do
    ...
    test "displays person", %{conn: conn, person: person, companies: companies} do
    ...
    test "updates person within modal", %{conn: conn, person: person, companies: companies} do
      {:ok, show_live, _html} = live(conn, Routes.person_show_path(conn, :show, person, companies))
